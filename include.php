...
function GetBlogPosts($inId=null, $inTagId =null)
{
    ...
    if (!empty($inId))
    {
        $database->query("SELECT * FROM blog_posts WHERE id = " . $inId . " ORDER BY id DESC");
    }
    ...
    {
        $database->query("SELECT * FROM blog_posts ORDER BY id DESC");
    }
...
function newBlogPosts($inId=null, $inTagId = null){}
?>
